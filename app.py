...
3. Enter a clear learning goal, for example:
    - "How to Create Jarvis AI Agent"
    - "How to Overcome DSA Fear and what steps needed to do"
""")

# Main content area
st.header("Enter Your Query")
user_goal = st.text_input("Enter your Query:",
                        help="Describe what you want to know, and we'll generate a structured path using YouTube content and your selected tool.")
